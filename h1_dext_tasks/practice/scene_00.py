...
parser.add_argument("--radius", type=float, default=1.0, help="Radius of the cone. Defaults to 1.0")
...
def design_scene():
    ...
    cfg_sphere.func("/World/Objects/Sphere", cfg_sphere, translation=(0.1, 0.0, 2.0))
