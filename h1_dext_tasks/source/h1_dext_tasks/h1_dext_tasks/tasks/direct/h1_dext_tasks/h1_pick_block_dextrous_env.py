...
from .h1_pick_block_dextrous_env_cfg import H1PickBlockDextrousEnvCfg


class H1PickBlockDextrousEnv(DirectRLEnv):
    cfg: H1PickBlockDextrousEnvCfg

    def __init__(self, cfg: H1PickBlockDextrousEnvCfg, render_mode: str | None = None, **kwargs):
    ...
    def _get_rewards(self) -> torch.Tensor:
        ...
        self.extras["log"]["hand_contact"] = (contact_bonus > 0.0).float().mean()
